...
import FilterTextFieldList from './FilterTextFieldList';
import { AVERAGE_RATING_OPTIONS, FICTION_OPTIONS } from '../utils/constants';

const FilterBooksButton = ({
  searchFields,
  setSearchFields,
  newSearchFields,
  setNewSearchFields,
  ...
  return (
    <>
      ...
      <div
        id="hs-basic-modal"
        className="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto flex justify-center items-center"
      >
        <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
          <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            ...
            <div className="grid gap-5 p-4 overflow-y-auto">
              <FilterTextFieldList
                name="authors"
                displayName="Authors"
                searchFields={newSearchFields}
                setSearchFields={setNewSearchFields}
              />
              <FilterTextFieldList
                name="genres"
                displayName="Genres"
